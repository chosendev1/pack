@extends('layouts.master')
    ...
    @section ('content')
     <div class="row">
      <div class="card">
          <div class="card-body">
            <h3 class="card-title">Guarantors For {Customer}</h3>      
          </div>
          <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="relationship_to_applicant" class="form-control">
                      </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="maritual_status" required>
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
                        <label class="form-label">Residential Address</label>
                        <input type="number" class="form-control" name="residential_address" required>
                      </div>
                    </div>
                    <div class="col-sm-6 col-md-4">
                      <div class="form-group">
